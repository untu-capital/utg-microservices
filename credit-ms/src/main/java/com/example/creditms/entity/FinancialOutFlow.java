...
@Entity
@Table()
public class FinancialOutFlow extends  AbstractEntity{
    @Column(name = "loan_id", nullable = false)
    @NotNull
    private String loanId;

    @Column(name = "outflow_name", nullable = false)
    @NotNull
    ...
    public void setOutflowName(String outflowName) {
        this.outflowName = outflowName;
    }
