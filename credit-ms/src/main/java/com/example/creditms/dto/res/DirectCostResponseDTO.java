...
public class DirectCostResponseDTO extends AbstractEntityDTO {
    ...
    public DirectCostResponseDTO() {
    }

    public DirectCostResponseDTO(String loanId, String costName, double month1, double month2, double month3, double month4, double month5, double month6, double month7, double month8, double month9, double month10, double month11, double month12) {
        this.loanId = loanId;
